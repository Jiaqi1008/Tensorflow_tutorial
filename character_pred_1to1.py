...
x_train=[id_onehot[w_id['a']],id_onehot[w_id['b']],id_onehot[w_id['c']],id_onehot[w_id['d']],id_onehot[w_id['e']]]
y_train=[w_id['b'],w_id['c'],w_id['d'],w_id['e'],w_id['a']]
...
checkpoint_path='./RNN/character_pred_1to1_ckpt/ckpt'
...
weight_path='./RNN/character_pred_1to1.txt'
...
for i in range(int(preNum)):
    ...
    alphabet_onehot=id_onehot[w_id[alphabet]]
    alphabet_onehot=np.reshape(alphabet_onehot,(1,1,5))
