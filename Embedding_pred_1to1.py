...
x_train=[w_id['a'],w_id['b'],w_id['c'],w_id['d'],w_id['e']]
...
checkpoint_path='./RNN/Embedding_pred_1to1_ckpt/ckpt'
...
weight_path='./RNN/Embedding_pred_1to1.txt'
...
for i in range(int(preNum)):
    ...
    alphabet_embedding=w_id[alphabet]
    alphabet_embedding=np.reshape(alphabet_embedding,(1,1))
